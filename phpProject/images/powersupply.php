...
<div class="row">
  ...
  <div class="product-info col-md-8 slideanim">
        ...
        <div id="truck">
          ...
          <div class="card ">
          <img src="images/power2.jpg" style="width: 100%; height: 300px;">
          <div>
          <br><br><br><br>
            <button type="button" class="btn btn-default btn-block" data-toggle="modal" data-target="#myModal_power2">View more</button>
              <!-- Modal -->
                <div class="modal fade" id="myModal_power2" role="dialog">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                      ...
                      <div class="modal-body">
                      <div class="row">
                        <div class="col-md-8"><img src="images/power2.jpg" style="width: 60%; height: 250px;">
                        </div>
                        <div class="col-md-4">
                        <h3>Bullet Camera</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque dapibus lectus id risus porta mattis. Vivamus augue magna, imperdiet quis ligula sed, condimentum mollis urna. Praesent lobortis felis at nulla malesuada, eget interdum metus sagittis.</p><br>
